...
public class Uporabnik {
    ...
    public Uporabnik(String uporabniskoIme, String ime, String priimek) {
        ...
        this.donacije = new ArrayList<>();  // Initialize the list in constructor too, just in case
    }

    public Uporabnik() {
        this.donacije = new ArrayList<>();  // Initialize the list in default constructor too
    }
